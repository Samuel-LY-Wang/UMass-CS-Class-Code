...
public class SpeedyEnemy extends Enemy {
    protected static final String className = "Speedy";
    ...
    public SpeedyEnemy(int wave, double position) {
        super(baseStats[0], baseStats[1], baseStats[2], baseStats[3], position, "Speedy");
