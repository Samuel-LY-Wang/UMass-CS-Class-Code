...
public class WeakEnemy extends Enemy {
    protected static final String className = "Weak";
    ...
    public WeakEnemy(int wave, double position) {
        super(baseStats[0], baseStats[1], baseStats[2], baseStats[3], position, "Weak");
