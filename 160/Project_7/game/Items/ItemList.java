...
public class ItemList {
    public static final Item[] items = {
        ...
        new HealItem(200, "Small health potion", "Restores 10% of your max HP", 5, 0.10),
        new HealItem(201, "Small health potion", "Restores 15 HP", 5, 15),
        new HealItem(202, "Medium health potion", "Restores 20% of your max HP", 10, 0.20),
        new HealItem(203, "Medium health potion", "Restores 25 HP", 10, 25),
        new HealItem(204, "Large health potion", "Restores 30% of your max HP", 15, 0.30),
        new HealItem(205, "Large health potion", "Restores 40 HP", 15, 40),
        new HealItem(206, "Giant health potion", "Restores 50% of your max HP", 20, 0.50),
        new HealItem(207, "Giant health potion", "Restores 80 HP", 20, 80),
        new HealItem(208, "Full health potion", "Restores 100% of your max HP", 30, 1.00),
        new HealItem(209, "Huge health potion", "Restores 150 HP", 30, 150),

        // END OF HEALS, BEGINNING OF OTHER/MISC ITEMS

        new Item(1000, "Banana", "It's just a banana.", 1)
    };
    ...
    public static final Map<Integer, Integer> itemFrequencies = new HashMap<>(
        Map.of(
            ...
            208, 5,
            209, 5,
            1000, 1 // Yeah you gotta be really lucky to find the banana lol
        )
